...
class MatchViewControllerTests: TBATestCase {
    ...
    override func setUp() {
        ...
        matchViewController = MatchViewController(match: match, urlOpener: urlOpener, myTBA: myTBA, persistentContainer: persistentContainer, tbaKit: tbaKit, userDefaults: userDefaults)
    ...
    func test_title_event() {
        ...
        match.event = event
        let vc = MatchViewController(match: match, urlOpener: urlOpener, myTBA: myTBA, persistentContainer: persistentContainer, tbaKit: tbaKit, userDefaults: userDefaults)
